...
import * as strings from 'MgStoreWebPartStrings';
...
export default class MgStoreWebPart extends BaseClientSideWebPart<IMgStoreWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IMgStoreProps> = React.createElement(
      App,
      {
