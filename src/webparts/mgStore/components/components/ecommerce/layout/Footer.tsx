        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <button onClick={goToHome} className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">SPFx Store</span>
            </button>
            <p className="text-background/70 text-sm leading-relaxed mb-6">
              A production-grade SharePoint Framework e-commerce solution built
              with React, PnP.js, and modern web technologies.
            </p>
