...
export function PromoStrip() {
  return (
    <section className="py-8 lg:py-12 bg-primary text-primary-foreground relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-6 items-center">
          ...
          >
            ...
            <h2 className="text-2xl lg:text-4xl font-bold mb-3 leading-tight text-balance">
              Summer Sale
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-2 bg-background text-foreground rounded-lg font-semibold hover:bg-background/90 transition-colors group text-sm"
            >
              Shop the Sale
            ...
            <div className="flex gap-3">
              {[
                ...
                <div key={item.label} className="text-center">
                  <div className="w-16 h-16 lg:w-20 lg:h-20 bg-background/10 backdrop-blur-sm rounded-lg flex items-center justify-center mb-1">
